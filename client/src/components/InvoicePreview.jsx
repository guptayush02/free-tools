...
//       y += 5;
//     }
//     if (invoice.payee?.phone) {
//       doc.text(invoice.payee.phone, marginLeft, y);
//       y += 5;
//     }
//     y += 5;
...
//       y += 5;
//     }
//     if (invoice.payer?.phone) {
//       doc.text(invoice.payer.phone, marginLeft, y);
//       y += 5;
//     }
//     y += 10;
...
//     // doc.rect(marginLeft, y - 5, pageWidth - marginLeft - marginRight, 8, 'F');
//     doc.setFillColor(240, 240, 240);
...
//     const qtyX = marginLeft + tableWidth * 0.55;
//     const priceX = marginLeft + tableWidth * 0.75;
//     const amountX = marginLeft + tableWidth * 0.95;
...
//     //   const description = doc.splitTextToSize(item.description || '', maxLineWidth - 70);
//     //   const itemAmount = (item.quantity * item.price).toFixed(2);
      
//     //   description.forEach((line, lineIdx) => {
//     //     doc.text(line, marginLeft + 2, y);
//     //     if (lineIdx === 0) {
//     //       doc.text(String(item.quantity), pageWidth - marginRight - 60, y);
//     //       doc.text(`${invoice.currency || '$'} ${Number(item.price).toFixed(2)}`, pageWidth - marginRight - 45, y);
//     //       doc.text(`${invoice.currency || '$'} ${itemAmount}`, pageWidth - marginRight - 2, y, { align: 'right' });
//     //     }
//     //     y += 5;
//     //   });
...
//       const priceStr = `${currency} ${Number(item.price).toLocaleString(undefined, {
//         minimumFractionDigits: 2,
//         maximumFractionDigits: 2,
//       })}`;
//       const amountNum = item.quantity * item.price;
//       const amountStr = `${currency} ${amountNum.toLocaleString(undefined, {
//         minimumFractionDigits: 2,
//         maximumFractionDigits: 2,
//       })}`;

//       // leave more room for description
//       const descMaxWidth = tableWidth * 0.5;
...
//     // doc.setFontSize(12);
//     // doc.setFont(undefined, 'bold');
//     // doc.text('TOTAL:', pageWidth - marginRight - 40, y);
//     // doc.text(`${invoice.currency || '$'} ${Number(invoice.total).toFixed(2)}`, pageWidth - marginRight - 2, y, { align: 'right' });

//     doc.setFontSize(12);
//     doc.setFont(undefined, 'bold');
//     doc.text('TOTAL:', priceX, y, { align: 'right' });

//     const totalStr = `${invoice.currency || '$'} ${Number(invoice.total).toLocaleString(undefined, {
//       minimumFractionDigits: 2,
//       maximumFractionDigits: 2,
//     })}`;
...
//       y += 6;
//       doc.setFont(undefined, 'normal');
//       const notesLines = doc.splitTextToSize(invoice.notes, maxLineWidth);
...
//       doc.save(`invoice_${invoice._id || 'draft'}_${Date.now()}.pdf`);
//     } catch (e) {
